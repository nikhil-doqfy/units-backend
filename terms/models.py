...
class TermsAndConditions(Base):
    ...
    country = models.ForeignKey(Country,on_delete=models.CASCADE,related_name="terms")
    category = models.ForeignKey(TermCategory,on_delete=models.CASCADE,related_name="terms")
