...
# #             mappings = PropertyDocumentsMapping.objects.filter(
# #                 property_id=property_id
...
# #                 doc_obj, created = Documents.objects.get_or_create(
# #                     file_name=file_name,
# #                     defaults={"file_path": file_url, "document_choice": doc_type}
# #                 )

# #                 if not created:
# #                     doc_obj.file_path = file_url
# #                     doc_obj.document_choice = doc_type
# #                     doc_obj.save()

# #                 # Ensure Mapping Exists
# #                 PropertyDocumentsMapping.objects.get_or_create(
# #                     property=property_obj,
# #                     document=doc_obj
# #                 )
...
#                     # tenant = TenantDetails.objects.filter(
#                     #          property=property_obj
#                     #         ).select_related("user", "lease_property_details").first()
#                     # lease_id = tenant.lease_property_details.id if tenant and tenant.lease_property_details else None
...
#             tenant_data["lease_id"] = int(lease_id)
...
#             property_obj.rental_status = constants.NOT_AVAILABLE
#             property_obj.save()
